...
<form action="EmpAddServlet" method="POST"
	...
	<fieldset>
		...
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" name="id" id="id" /><label id="id_msg"></label>
			</div>
		</div>
		...
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" name="name"  /><label id="name_msg"></label>
			</div>
		</div>
		...
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" id="password" name="password"/><label id="password_msg"></label>
			</div>
		</div>
		...
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" id="nickname" name="nickname"/><label id="nickname_msg"></label>
			</div>
		</div>
		...
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" id="cellphone" name="cellphone" /><label id="cellphone_msg"></label>
			</div>
		</div>
		...
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" id="email" name="email" /><label id="emailmsg"></label>
			</div>
		</div>
		...
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" id="idcard" name="idcard" /><label id="idcard_msg"></label>
			</div>
		</div>
		...
		<div class="control-group ">
			...
			<div class="controls">
				...
				<input type="text" id="birthday" name="birthday" /><label id="birthday_msg"></label>
			</div>
		</div>
